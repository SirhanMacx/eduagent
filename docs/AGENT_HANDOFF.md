...
**Drive:** OAuth + rate limiting, 6 tools (upload, list, organize, create_slides, create_doc, read)
**Scheduler:** Proactive scheduling via handle_system_event(), 5 built-in tasks, schedule_task tool
**Custom Tools:** YAML prompt-template tools from ~/.eduagent/tools/
**Planner:** Multi-step request decomposition for complex tasks
