...
These files were generated by Claw-ED from a real teacher's curriculum (30 observation lessons ingested, persona extracted automatically). Zero manual editing.

| File | What it is |
|------|-----------|
| [French Revolution lesson (JSON)](samples/French_Revolution_lesson.json) | Full lesson plan with INSPECT chart, jigsaw, writing frames, 3-part Do Now |
| [Civil War lesson plan (DOCX)](samples/Civil_War_lesson_plan.docx) | Print-ready lesson plan with standards, timing table, differentiation |
| [Civil War student handout (DOCX)](samples/Civil_War_student_handout.docx) | Student-facing worksheet with Do Now box, lined response areas, exit ticket |
| [Ottoman Empire slides (PPTX)](samples/Ottoman_Empire_slides.pptx) | 14-slide deck with 5 academic images, speaker notes, section dividers |
| [Renaissance slides (PPTX)](samples/Renaissance_slides.pptx) | 12-slide deck using teacher's own extracted images from prior presentations |
| [Extracted persona (JSON)](samples/extracted_persona.json) | Auto-extracted pedagogical fingerprint: INSPECT charts, jigsaw, desk islands, signature moves |
