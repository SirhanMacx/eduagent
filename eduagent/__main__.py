"""Allow running with: python -m eduagent"""
import sys
...
def _handle_error(e):
    ...
    if "UnicodeEncodeError" in name or "UnicodeDecodeError" in name:
        ...
        console.print("[red]Authentication failed.[/red] Check your API key: eduagent config show")
    elif "404" in msg and "model" in msg.lower():
        console.print(f"[red]Model not found.[/red] {msg}")
    else:
        console.print(f"[red]Error:[/red] {msg}")
        console.print("[dim]Run with --verbose for details, or report at github.com/SirhanMacx/eduagent/issues[/dim]")
