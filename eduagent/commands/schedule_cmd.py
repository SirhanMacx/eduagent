...
from eduagent.commands._helpers import console, run_async
...
def schedule_disable(
    ...
    from eduagent.scheduler import disable_task
...
def schedule_run(
    ...
    from eduagent.scheduler import run_task
...
def schedule_set(
    ...
    from eduagent.scheduler import set_task_schedule
...
def schedule_start() -> None:
    ...
    from eduagent.scheduler import EduScheduler
