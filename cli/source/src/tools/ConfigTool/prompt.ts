...
export const DESCRIPTION = 'Get or set Claw-ED configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set Claw-ED configuration settings.

  View or change Claw-ED settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
