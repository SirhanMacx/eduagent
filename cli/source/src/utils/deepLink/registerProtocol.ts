...
const APP_NAME = 'Claw-ED URL Handler'
const DESKTOP_FILE_NAME = 'claude-code-url-handler.desktop'
const MACOS_APP_NAME = 'Claw-ED URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>Claw-ED Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for Claw-ED
