...
/**
 * Resolve Claw-ED-specific path patterns for sandbox-runtime.
 *
 * Claw-ED uses special path prefixes in permission rules:
...
/**
 * Convert Claw-ED settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where Claw-ED started)
