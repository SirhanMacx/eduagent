...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when Claw-ED was first started on this machine
  ...
  // Claw-ED usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first Claw-ED OAuth token
  ...
  // Claw-ED hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
