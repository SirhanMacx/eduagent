      ...
      {step === 'consent' && <Box flexDirection="column">
          ...
          <Box marginTop={1}>
            <Text wrap="wrap" dimColor>
              ...
              Claw-ED&apos;s functionality (eg. to reduce the risk of bugs
