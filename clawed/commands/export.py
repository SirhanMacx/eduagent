...
{"".join(sections)}
<div class="footer">\
Generated by Claw-ED &mdash; \
<a href="https://github.com/SirhanMacx/Claw-ED">\
github.com/SirhanMacx/Claw-ED</a></div>
</body>
</html>
"""
...
<div class="get-started">
  <h2>Get Started</h2>
  <ol>
    <li><code>pip install clawed</code></li>
    <li><code>clawed config set-model ollama</code> &nbsp;(free, local)</li>
    <li><code>clawed ingest ~/your-lesson-plans/</code></li>
    <li><code>\
clawed full "Photosynthesis" --grade 8 --subject science --weeks 2\
</code></li>
  </ol>
  <p style="margin-top:1rem;">GitHub: \
<a href="https://github.com/SirhanMacx/Claw-ED">\
github.com/SirhanMacx/Claw-ED</a></p>
</div>
</body>
</html>
"""
...
def share(
    ...
    out_dir = Path("clawed_output/shared").resolve()
...
def demo(
    ...
    what Claw-ED generates. No setup required.
    """
    if web:
        out_dir = Path("~/clawed_output").expanduser().resolve()
        out_dir.mkdir(parents=True, exist_ok=True)
    ...
    console.print(
        Panel(
            "[bold green]Claw-ED Demo[/bold green]"
            " — no API key needed\n"
    ...
    console.print(
        Panel(
            ...
            " materials:[/bold]\n\n"
            "  1. [cyan]pip install clawed[/cyan]\n"
            "  2. [cyan]clawed config set-model ollama[/cyan]"
            "  (free, local)\n"
            "  3. [cyan]clawed ingest"
            " ~/your-lesson-plans/[/cyan]\n"
            '  4. [cyan]clawed full "Photosynthesis"'
