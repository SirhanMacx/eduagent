...
if TYPE_CHECKING:
    from clawed.bot_state import BotStateStore
    ...
    def start(
        ...
        *,
        ...
        async def _llm_call_with_retry(text: str, teacher_id: str) -> str:
            ...
            from clawed.openclaw_plugin import handle_message as process
        ...
        async def cmd_progress(update: Any, context: Any) -> None:
            ...
            try:
                ...
                from clawed.state import _get_conn as _get_main_conn
