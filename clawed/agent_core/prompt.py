...
def build_system_prompt(
    *,
    ...
    sections.append(
        ...
        "**LESSON VARIETY — CRITICAL:**\n"
        "NEVER repeat the same lesson structure. Rotate through these formats:\n"
        "- Document Analysis (primary sources, close reading)\n"
        "- Gallery Walk (stations with artifacts/images on walls)\n"
        "- Socratic Seminar (student-led discussion with text)\n"
        "- Fishbowl Debate (inner/outer circles, opposing viewpoints)\n"
        "- I Do / We Do / You Do (gradual release of responsibility)\n"
        "- Station Rotation (4-5 stations with different activities)\n"
        "- Simulation / Role Play (students take on historical roles)\n"
        "- Case Study Analysis (real-world scenario investigation)\n"
        "- Compare & Contrast (Venn diagrams, T-charts, matrices)\n"
        "- DBQ Workshop (document-based question practice)\n"
        "- Jigsaw (expert groups teach each other) — USE SPARINGLY\n"
        "Do NOT default to jigsaw. Pick the format that best fits the "
        "content. A lesson on causes → Compare & Contrast. A lesson on "
        "a speech → Document Analysis. A lesson on a debate → Fishbowl. "
        "A lesson on a period → Gallery Walk or Stations.\n\n"
